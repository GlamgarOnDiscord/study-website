...
Study-Website est un site conçu spécialement pour les étudiants qui permet de réviser avec de nombreuses fonctionnalités utiles, telles qu'un chronomètre, une liste de tâches modifiable et de la musique customisable pour une ambiance de travail propice à la concentration. C'est un outil idéal pour les étudiants souhaitant maximiser leur productivité.

## Fonctionnalités 🔨

- Chronomètre
- Liste de tâches modifiable
- Musique personnalisable pour une ambiance de travail propice à la concentration
